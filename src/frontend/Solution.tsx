...
import { comment_solution, commit_actions, get_domains, get_latest_block, get_peer, get_proposal, get_proposals, get_solution, get_solution_votes, get_sub_domains, has_vote_solution, ipfs_add, ipfs_get, vote_solution } from './utils';
import { ActionMakeProposal, ActionType, CommonProposal, CommonSolution, DBDomainProposalPair, DBProposal, DBSolution, DBSolutionComment, DBTask, DomainEntity, DomainID, ProposalStatus, VIAssignToEntity, VISelfUpgrade, VITask, VITaskType } from '../shared/types';
import { decode } from '../shared/utils';
import { Buffer } from 'buffer';

const Solution =({id, proposal_id, conference_id}: {id: string, proposal_id: string, conference_id: string}) => {
