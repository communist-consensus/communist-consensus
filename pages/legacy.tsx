...
import {
  connect_to_peer,
  get_initialized,
  load_text_from_file_element,
  load_text_from_file_element as load_text_from_file_input,
  post_init,
  resume,
  save_to_file,
} from './utils';
...
const get_initial_action_bundle = (
  profile_a: Profile,
  profile_b: Profile,
): ActionBundle => [
  [
...
export default () => {
  ...
  const signature = useRef<Uint8Array>();
            ...
            <Button
              ...
              onClick={async () => {
                if (mode === InitMode.initiator && activeStep === 3) {
                  ...
                  // const peer_json: PeerIDJSON = JSON.parse(peer_json_str);
                  // const config: ConsensusConfig = {
                  //   peer_id_json: peer_json,
                  //   bootstrap_public_key,
                  // };
                  // set_config(config);
